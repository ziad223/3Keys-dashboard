  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-[20px] lg:text-[24px] font-bold text-[#00614E]">المكاتب العقارية</h1>
          <p className="text-[14px] text-[#4E525D] mt-3">تحكم كامل في المكاتب، والاشتراكات والوسطاء.</p>
        </div>
