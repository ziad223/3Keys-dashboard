// components/SubscribeUnitActionConfirmModal.tsx
'use client'
...
type SubscribeUnitActionConfirmModalProps = {
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
  type: ActionType
...
const SubscribeUnitActionConfirmModal = ({ 
  isOpen, 
  onClose, 
  onConfirm, 
  type,
  title,
  message 
}: SubscribeUnitActionConfirmModalProps) => {
...
export default SubscribeUnitActionConfirmModal